...
namespace ShoppingCart.Core.Logging
{
    public class LoggingManager<T> : ILoggingManager<T>
    {
        ...
        public LoggingManager(ILogger<T> logger)
        {
            ...
            this._logger = logger;
            //// TODO: Build fault tolerant defaulting config settings class.           
            // apiVersion = _configuration.GetSection("ApiVersion").Value;   
            //    module = _configuration.GetSection("Module").Value;
        } 
